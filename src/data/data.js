  ...
  "data": [
    {
      ...
      "deskripsi": "Today we will be building a very simple To-Do List app using pure javascript, you can check it out live here. A good practice exercise for…",
      "gambar": "https://miro.medium.com/fit/c/1366/638/1*VTKsiByHMcWDIxpFawp4fg.png",
      "pembuat": "Dominic Fraser",
      "id": 1
    },
    {
      "title": "How we built a survey app from scratch using ReactJS at SnackNation (1/2)",
      "deskripsi": "“Where do I start?…” This is probably the most recurrent question when it comes to implementing a react project. Components are cool to…",
    ...
    },
    {
      ...
      "deskripsi": "At first, like most people, I was skeptical of using Facebook’s React . Demos of the extension of React Java Script programming language…",
